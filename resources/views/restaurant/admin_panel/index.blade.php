...
<form action="addproduct.php" class="form-horizontal" method="post" enctype="multipart/form-data">
    ...
    <fieldset>
        ...
        <div class="form-group row">
            ...
            <div class="col-lg-10">
                <input type="text" class="form-control form-control-sm" id="prodName" name="prodName"
        ...
        <div class="form-group row">
            ...
            <div class="col-lg-10">
                <input type="text" class="form-control form-control-sm" id="prodPrice" name="prodPrice"
                    placeholder="2500">
            </div>
        </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-lg-10">
                <textarea class="form-control form-control-sm" id="prodDescription" name="prodDescription"
                    placeholder="Details about your Product. (300 words or less..)"></textarea>
            </div>
        </div>
